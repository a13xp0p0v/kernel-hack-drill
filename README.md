...
| __drill_uaf_callback_rop_smep.c__ | a basic use-after-free exploit invoking a callback in the freed `drill_item_t` struct; it performs control flow hijack and gains LPE and SMEP buypass via ROP/JOP|
