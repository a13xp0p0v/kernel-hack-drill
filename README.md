...
| __drill_oob_w_pipe_buffer.c__ | a basic OOBW exploit that corrupts the `pipe_buffer.page` pointer to perform AARW of kernel memory via a pipe and gains LPE. |
